...
| Document                           | Contents                                                                               |
| ---------------------------------- | -------------------------------------------------------------------------------------- |
| [Routes](routes.md)               | All HTTP endpoints — pages, API partials, chart images, health check, OpenAPI          |
| [Services](services.md)           | Data pipeline, analysis services, tisk pipeline, Ollama integration                    |
| [Templates](templates.md)         | Frontend structure, HTMX patterns, i18n, vote detail, skeleton loading, styling        |
| [Data Model](data-model.md)       | Electoral periods, UNL format, table schemas, vote codes, tisk data, Ollama/env config |
